    ...
    for line in open('cumulative.tab','r'):
        ...
        if number==koinumber:
            ...
            if disposition=='CANDIDATE':
                ...
                output.write(' <img style="border:1px solid #000000" src="http://phoenix.dunlap.utoronto.ca/~carl.ziegler/KOI'+str(number)+'_cutout.png" alt="KOI-'+str(number)+'" height="384" width="384">'+'\n')
                output.write(' <span style="display:inline-block; width: 40px;"></span>'+'\n')
                output.write(' <img style="border:1px solid #000000" src="http://phoenix.dunlap.utoronto.ca/~carl.ziegler/'+str(number)+'.png" alt="KOI-'+str(number)+'" height="384" width="384">'+'\n')
                output.write('  <span style="display:inline-block; width: 40px;"></span>'+'\n')
                output.write('    <img title="KOI-'+str(number)+'" src="http://phoenix.dunlap.utoronto.ca/~carl.ziegler/'+str(number)+'_quarter4_pixels.png" onmouseover="this.src='+'\''+'http://phoenix.dunlap.utoronto.ca/~carl.ziegler/'+str(number)+'_quarter4_pixels_aperture.png'+'\''+'" onmouseout="this.src='+'\''+'http://phoenix.dunlap.utoronto.ca/~carl.ziegler/'+str(number)+'_quarter4_pixels.png'+'\''+'" height="424"/></a>'+'\n')
                if len(str(number))==1:
                ...
                output.write(' <img style="border:0px solid #000000" src="http://phoenix.dunlap.utoronto.ca/~carl.ziegler/'+str(number)+'_image_sensitivity.png" alt="KOI-'+str(number)+'" height="322" width="571">'+'\n')
                    ...
                    if keplerplanet==str(number):
                        try:
                            ...
                            if str(newline.split('\t')[3])=='CANDIDATE':
                                output.write('     <td><h5><a href="http://phoenix.dunlap.utoronto.ca/~carl.ziegler/'+planetnumber+'_lc.png" target="_blank">'+planetnumber+'<br></h5></td>'+'\n')
                ...
                output.write('   <tr>'+'\n')
                nearbystars=0
                for line3 in open('updated_planet_radii.tex','r'):
            ...
            if disposition=='FALSE POSITIVE':
                ...
                if roboaoobserved==False:
                    ...
                    output.write(' <span style="display:inline-block; width: 30px;"></span><img style="border:1px solid #000000" src="http://phoenix.dunlap.utoronto.ca/~carl.ziegler/'+str(number)+'.png" alt="KOI-'+str(number)+'" height="384" width="384">'+'\n')
                    output.write('  <span style="display:inline-block; width: 40px;"></span>'+'\n')
                    output.write('    <img title="KOI-'+str(number)+'" src="http://phoenix.dunlap.utoronto.ca/~carl.ziegler/'+str(number)+'_quarter4_pixels.png" onmouseover="this.src='+'\''+'http://phoenix.dunlap.utoronto.ca/~carl.ziegler/'+str(number)+'_quarter4_pixels_aperture.png'+'\''+'" onmouseout="this.src='+'\''+'http://phoenix.dunlap.utoronto.ca/~carl.ziegler/'+str(number)+'_quarter4_pixels.png'+'\''+'" height="424"/></a>'+'\n')
